...
## V3.4 Gerenciamento de sessão baseado em cookies
...
## V3.5 Gerenciamento de sessão baseado em token

O gerenciamento de sessão baseado em token inclui chaves JWT, OAuth, SAML e API. Destas, as chaves de API são conhecidas por serem fracas e não devem ser usadas em novos códigos.
