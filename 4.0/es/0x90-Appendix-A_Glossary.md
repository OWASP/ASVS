# Apéndice A: Glosario
 ...
 - **Permitir lista:** Una lista de datos u operaciones permitidas, por ejemplo, una lista de caracteres que pueden realizar la validación de entrada.
 ...
 - **Informe de verificación de seguridad de la aplicación:** Un informe que documenta los resultados generales y el análisis de soporte generado por el verificador para una aplicación determinada.
 ...
 - **Identificador único mundial (GUID):** Un número de referencia único utilizado como identificador en el software.
 ...
 - **Claves codificadas:** Claves criptográficas que se almacenan en el sistema de archivos, ya sea en código, comentarios o archivos.
 ...
 - **Hibernate Query Language (HQL):** Lenguaje de consulta de apariencia similar al SQL utilizado por la biblioteca ORM de hibernación.
 ...
 - **OTP basado en el tiempo:** Método de generación de un OTP en el que el tiempo actual actúa como parte del algoritmo para generar la contraseña.
 ...
 - **2º Factor Universal (U2F):** Una de las normas creadas por FIDO específicamente para permitir el uso de una llave de seguridad USB o NFC como 2º factor de autenticación.
 ...
 - **Lo que ves es lo que obtienes (WYSIWYG):** Un tipo de editor de contenido rico que muestra cómo se verá realmente el contenido cuando se renderice en lugar de mostrar la codificación usada para gobernar la renderización.
