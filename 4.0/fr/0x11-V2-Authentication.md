...
| **2.1.9** | Vérifiez qu'il n'existe pas de règles de composition des mots de passe limitant le type de caractères autorisés. Il ne doit pas y avoir de majuscules ou de minuscules, de chiffres ou de caractères spéciaux. ([C6](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 521 | 5.1.1.2 |
...
| **2.10.2** | Vérifiez que si des mots de passe sont requis, l'autheitification ne soit pas un compte par défaut. | | OS assisté | HSM | 255 | 5.1.1.1 |
