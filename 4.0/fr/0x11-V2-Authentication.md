...
| **2.1.4** | Vérifiez que tous caractères Unicode imprimables, y compris les caractères neutres comme les espaces et les Emojis, sont autorisés dans les mots de passe. | ✓ | ✓ | ✓ | 521 | 5.1.1.2 |
