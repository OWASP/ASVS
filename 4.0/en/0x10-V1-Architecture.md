...
| **1.11.2** | Verify that all high-value business logic flows, including authentication, session management and access control, maintain a consistent application state and check it to prevent race conditions and business logic flaws. | | ✓ | ✓ | 362 |
