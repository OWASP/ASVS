...
| # | Description | L1 | L2 | L3 | NIST &sect; |
| --- | --- | --- | --- | -- | -- |
| 3.2.1 | Verify that session tokens are created or generated after authentication, not before. | ✓ | ✓ | ✓ | 7.1 |
| 3.2.2 | Verify that session tokens are created using approved cryptographic algorithms with at least 64 bits of entropy. | ✓ | ✓ | ✓ | 7.1 |
| 3.2.3 | Verify that session tokens are not stored in insecure local storage, such as HTML 5 local storage. | ✓ | ✓ | ✓ | 7.1 |
| 3.2.4 | Verify that active session functionality exists, which allows users to either selectively or completely log out all active devices / sessions. |  | ✓ | ✓ | 7.1 |
...
| # | Description | L1 | L2 | L3 | NIST &sect; |
| --- | --- | --- | --- | -- | -- |
| 3.4.1 | Verify that cookie-based session IDs have the 'Secure' attribute. | ✓ | ✓ | ✓ | 7.1.1 |
| 3.4.2 | Verify that cookie-based session IDs have the 'HttpOnly' attributes. | ✓ | ✓ | ✓ | 7.1.1 |
