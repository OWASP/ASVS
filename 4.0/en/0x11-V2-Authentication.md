...
| **2.23** | Verify the authenticator permits a limited number of bad login attempts before temporarily locking the account, particularly where longer memorized secrets are required. | ✓ | ✓ | ✓ | 4.0 | TBA |
