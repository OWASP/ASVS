...
### V2.6 Look-up Secret Requirements
...
| 2.7.2 | Verify that restricted out of band authenticators, such as SMS or PSTN, are not offered by default and stronger alternatives such as push notifications are offered first. | ✓ | ✓ | ✓ | 5.1.3.1 |
...
| # | Description | L1 | L2 | L3 | NIST &sect; |
| --- | --- | --- | --- | -- | -- |
| 2.x.1 | Verify that TBA. | ✓ | ✓ | ✓ | TBA |
| 2.x.2 | Verify that TBA. | ✓ | ✓ | ✓ | TBA |

### V2.9 Multi-factor OTP Requirements
...
### V2.10 Cryptographic Software and Devices
