...
Version 4.0.2 is the second minor update to v4.0 intended to fix spelling errors and make requirements clearer without materially changing requirements or adding/removing requirements.
