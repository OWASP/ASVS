...
- **Verifier** – La persona o il team che sta analizzando un'applicazione rispetto ai requisiti OWASP ASVS (Open Worldwide Application Security Project Application Security Verification Standard).
