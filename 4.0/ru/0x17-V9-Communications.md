...
| :---: | :--- | :---: | :---:| :---: | :---: |
| **9.1.1** | Убедитесь, что для клиентских подключений используется протокол TLS, и при этом он не оставляет соединения без защиты (незашифрованными или неаутентифицированными). ([C8](https://owasp.org/www-project-proactive-controls/v3/en/c8-protect-data-everywhere.html)) | ✓ | ✓ | ✓ | [319](https://cwe.mitre.org/data/definitions/319.html) |
| **9.1.2** | С помощью современных инструментов тестирования TLS убедитесь, что включены только стойкие шифронаборы, при этом наиболее стойкие из них выбраны как предпочтительные. | ✓ | ✓ | ✓ | [326](https://cwe.mitre.org/data/definitions/326.html) |
| **9.1.3** | Убедитесь, что включены только актуальные и рекомендуемые версии протокола TLS, такие как TLS 1.2 и TLS 1.3. Наиболее свежая версия TLS должна быть выбрана как предпочтительная. | ✓ | ✓ | ✓ | [326](https://cwe.mitre.org/data/definitions/326.html) |
...
| **9.2.3** | Убедитесь, что все зашифрованные соединения с внешними системами, передающие конфиденциальную информацию или функции, аутентифицированы. | | ✓ | ✓ | [287](https://cwe.mitre.org/data/definitions/287.html) |
| **9.2.4** | Убедитесь, что включена и настроена процедура отзыва сертификатов, например, Online Certificate Status Protocol (OCSP) Stapling. | | ✓ | ✓ | [299](https://cwe.mitre.org/data/definitions/299.html) |
| **9.2.5** | Убедитесь, что сбои TLS-соединений со стороны сервера  регистрируются в журнале. | | | ✓ | [544](https://cwe.mitre.org/data/definitions/544.html) |
