...
| **11.1.6** | Убедитесь, что приложение не подверженно атакам типа «момент проверки до момента использования» (TOCTOU) или других условий гонки для конфиденциальных операций. | | ✓ | ✓ | 367 |
