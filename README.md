...
* [OWASP Application Security Verification Standard 5.0.0 French (PDF)](5.0/OWASP_Application_Security_Verification_Standard_5.0.0_fr.pdf) and [other formats](5.0/docs_fr). (Thanks to [clallier94](https://github.com/clallier94), [inza](https://github.com/inaz0), [Michael Vacarella](https://github.com/Aif4thah), [Sebastien gioria](https://github.com/SPoint42))
