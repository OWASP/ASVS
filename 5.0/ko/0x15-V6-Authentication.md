...
[NIST SP 800-63](https://pages.nist.gov/800-63-3/)은 전 세계 조직에 유용한 현대적이고 증거 기반의 표준이나, 특히 미국 정부 기관 및 그와 상호작용하는 조직에 매우 관련성이 높다.
...
추가적으로, NIST SP 800-63의 용어와는 일부 경우 다를 수 있으며, 본 장은 명확성을 높이기 위해 더 일반적으로 이해되는 용어를 사용한다. 
