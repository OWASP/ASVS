...
Der Application Security Verification Standard definiert drei Stufen der Sicherheitsverifikation, wobei jede Stufe an Tiefe zunimmt.The Application Security Verification Standard defines three security verification levels, with each level increasing in depth.
...
Wir haben von einigen Personen Rückmeldungen erhalten, wie sie den Standard in ihrer Praxis nutzen:

### Persönliche Erfolgsgeschichten

#### Matthew Hackling

* leitet Umfang und Testfälle für Pentests ab
* leitet die Sicherheitsanforderungen zur Unterstützung des Designs ab
* entwickelt die Anforderungen für den organisatorischen Rahmen gemäß ISO27034

#### Dominique Righetto

* nutzt den Standard für Code Reviews und als Checkliste für Schwachstellenanalysen

#### Giovanni Cruz

* Während der letzten OWASP Latam Tour Bogotá 2019 wurde ein Kurs komplett auf Basis des ASVS aufgebaut. Sämtliche Inhalte wurde mit Hilfe einer verwundbaren Webanwendung erstellt, um Softwareentwickler zu unterstützen. Das Feedback war sehr positiv. Im Kurs wurde gezeigt, wie der Standard genutzt wird und welche Sicherheitsniveaus auf seiner Basis erreicht werden könnten.

#### Sebastien Gioria

* Einige Kunden nutzen den ASVS als verbindliche Sicherheitsanforderung für Design und Entwicklung

#### Riotaro Okada

* In den letzten Jahren begannen japanische Banken den ASVS als verbindliche Anforderung für Testdienstleistungen aufzunehmen. Sie erwarten von ihren Auftragnehmern, dass diese die entsprechenden ASVS-Stufen erfüllen.
* Ein japanischer Softwarehersteller wurde von einem potentiellen Kunden gebeten, zu prüfen, welche ASVS-Stufen seine Produkte erfüllen. Er nahm dies zum Anlass, in seinem Team Methoden der sicheren Softwareentwicklung einzuführen.

#### John Patrick Lita

* integriert den Standard in seine CI/CD Prozesse.

### Use within other projects and tools

* OWASP Defectdojo unterstützt ASVS https://www.defectdojo.org/
* Kurz nachdem die Version 4 erschien, unterstützte es RIPS: https://blog.ripstech.com/2019/rips-3.1-adds-teamcity-ldap-jsp-support/
...
- Die <Version> benennt die Version des ASVS. Im Laufe der Entwicklung des ASVS kann sich die Nummerierung zwischen den Versionen des Standards ändern. Das sich Referenzen ohne Versionsangebe immer auf die aktuelle Version des Standards beziehen, kann dies problematisch werden. Das „v“ wird dabei klein geschrieben.
...
- Der <Abschnitt > referenziert auf den Abschnitt, in dem die Anforderung beschrieben wird, z.B.: alle Anforderungen mit der Nummer 1.11.* beziehen sich auf die architekturellen Anforderugen an die Geschäftslogik.
