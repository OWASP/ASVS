...
## Proyek Cheat Sheet OWASP

[Proyek ini](https://owasp.org/www-project-cheat-sheets/) memiliki beberapa cheat sheet yang relevan dengan berbagai topik dalam ASVS.

Terdapat pemetaan ke ASVS yang dapat ditemukan di sini: [https://cheatsheetseries.owasp.org/IndexASVS.html](https://cheatsheetseries.owasp.org/IndexASVS.html)

## Proyek-proyek Terkait Keamanan Mobile
...
## Proyek-proyek terkait Internet of Things OWASP
...
## Proyek OWASP Serverless

1. OWASP Serverless Project: [https://owasp.org/www-project-serverless-top-10/](https://owasp.org/www-project-serverless-top-10/)

## Yang lain

Demikian pula, situs web berikut ini kemungkinan besar akan bermanfaat bagi pengguna/pengadopsi standar ini.
