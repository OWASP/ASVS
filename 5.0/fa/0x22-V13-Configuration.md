...
| **13.4.7** | لایه وب باید به‌گونه‌ای پیکربندی شده باشد که فقط فایل‌هایی با پسوندهای مشخص را سرو کند تا از افشای تصادفی اطلاعات، پیکربندی و کد منبع جلوگیری شود. | 3 |
