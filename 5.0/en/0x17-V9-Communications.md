...
| **9.3.3** | [ADDED] Verify that mutual TLS (mTLS) is used for intra-service communications to ensure all the involved parties at each end of a network connection are who they claim to be. This promotes zero trust security practice in a system. | | | ✓ | 295 |
