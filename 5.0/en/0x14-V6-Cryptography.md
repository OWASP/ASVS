...
| **6.2.6** | [MODIFIED] Verify that nonces, initialization vectors, and other single use numbers are not be used for more than one encryption key/data-element pair. The method of generation must be appropriate for the algorithm being used. | | ✓ | ✓ | 326 |
