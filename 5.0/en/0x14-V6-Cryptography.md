...
| **6.3.3** | [GRAMMAR, LEVEL L3 > L1] Verify that random number generation cotninues to work securely, even under heavy system load, or that the system degrades gracefully. | 1 | 338 |
