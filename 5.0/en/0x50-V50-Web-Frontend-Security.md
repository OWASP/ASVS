...
| **50.2.3** | [MODIFIED, MOVED FROM 3.4.3, LEVEL L1 > L2] Verify that each cookie's 'SameSite' attribute value is set according to the purpose of the cookie, to limit exposure to browser-based forgery attacks, commonly known as cross-site request forgery (CSRF), and user interface redress attacks. | 2 |
