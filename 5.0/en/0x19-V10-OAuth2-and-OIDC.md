...
| **10.4.14** | Verify that the authorization server issues only sender-constrained (Proof-of-Possession) access tokens, either using certificate-bound access tokens with mTLS or DPoP-bound access tokens (Demonstration of Proof of Possession). | 3 | v5.0.be-51.4.11 |
