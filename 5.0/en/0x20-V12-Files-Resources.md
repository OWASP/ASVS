...
This section contains requirements to mitigate risks when serving files to be downloaded downloading, including path traversal and injection attacks.
...
| **12.5.6** | [MODIFIED, MOVED FROM 12.4.2] Verify that files obtained from untrusted sources are scanned by antivirus scanners to prevent upload and serving of known malicious content. | 1 | 509 |
