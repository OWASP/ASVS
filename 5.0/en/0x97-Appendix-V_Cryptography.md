...
V6 goes beyond simply defining best practices. It aims to enhance understanding of cryptography principles and encourage the adoption of more resilient, modern security methods. This appendix provides detailed technical information regarding each requirement, complementing the overarching standards outlined in V6 by specifying which crytographic mechanisms might be used in an application.

**Approved** (A) mechanisms can be used in applications without reserve.

**Legacy** mechanisms (L) should not be used in applications but might still be used for compatibility with existing legacy applications or code. They must not be used for compatiblity with existing legacy application or code. While the usage of such a mechanism is currently not considered to be a vulnerability in itself, they should be replaced by more secure and future-proof mechanisms as soon as possible.

**Disallow** mechanisms (D) must not be used.
...
## RNG Methods and Algorithms (V6.3)
...
| XTS | No | [NIST SP 800-38E](https://csrc.nist.gov/pubs/sp/800/38/e/final) | A | Disk-level block encryption |
| XEX | No | [Rogaway 2004](https://doi.org/10.1007/978-3-540-30539-2_2) | A | Disk-level block encryption |
| LRW | No | [Liskov, Rivest, and Wagner 2005](https://doi.org/10.1007/s00145-010-9073-y) | A | Disk-level block encryption |
| ECB | No | | D | |
| CFB | No | | D | |
| OFB | No | | D | |
| CTR | No | | D | |
...
The following table lists hash functions approved in general cryptographic use cases such as digital signatures. They provide strong collision resistance and are suitable for high-security applications. Some of these algorithms offer strong resistance to attacks when used with proper cryptographic key management, and so are additionally approved for HMAC, KDF, and RBG functions.
...
| SHA-224 | [FIPS 180-4](https://csrc.nist.gov/pubs/fips/180-4/upd1/final) | L | Not suitable for HMAC/KDF/RBG |
| SHA-512/224 | [FIPS 180-4](https://csrc.nist.gov/pubs/fips/180-4/upd1/final) | L | Not suitable for HMAC/KDF/RBG |
| SHA3-224 | [FIPS 202](https://csrc.nist.gov/pubs/fips/202/final) | L | Not suitable for HMAC/KDF/RBG |
| SHA-1 | [RFC 3174](https://www.rfc-editor.org/info/rfc3174) & [RFC 6194](https://www.rfc-editor.org/info/rfc6194) | L | Not suitable for HMAC/KDF/RBG |
| CRC (any length) |  | D |
...
| PBKDF2_SHA1 | [NIST SP 800-132](https://csrc.nist.gov/pubs/sp/800/132/final), [FIPS 180-4](https://csrc.nist.gov/pubs/fips/180-4/upd1/final) | 1,300,000 | L |
...
|--|--|--|
| RSA | k >= 2048 | A |
| Finite Field Diffie-Hellman (FFDH) | L >= 2048 & N >= 224 | A |
| Elliptic Curve Diffie-Hellman (ECDH) | f >= 224 | A |
...
| KMAC128       | [NIST SP 800-185](https://csrc.nist.gov/pubs/sp/800/185/final)                             | A | Not suitable for HMAC/KDF/RBG |
| KMAC256       | [NIST SP 800-185](https://csrc.nist.gov/pubs/sp/800/185/final)                             | A | Not suitable for HMAC/KDF/RBG |
| BLAKE3        |  [BLAKE3 one function, fast everywhere](https://github.com/BLAKE3-team/BLAKE3-specs/raw/master/blake3.pdf)  | A | |
