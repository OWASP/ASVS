...
This section considers key requirements to ensure that the application implements WebSockets correctly and is not vulnerable to attacks that exploit this real-time communication channel. A WebSocket is a communications protocol, providing a simultaneous two-way communication channel over a single TCP connection. It was standardized by the IETF as RFC 6455 in 2011 and is a distinct from HTTP even if it is designed to work over HTTP ports 443 and 80. 
...
Properly implemented validation of HTTP Request headers prevent attacks such as HTTP Request Smuggling and API abuse. 
...
This section focuses on security considerations and protections on HTTP/2 network protocol. 
