...
| # | Description | Level | CWE |
| :---: | :--- | :---: | :---: |
| **13.7.1** | [ADDED] Verify that the value in the Content-Length request header field matches the calculated length using the built-in mechanism. | 3 | 400 |
| **13.7.2** | [ADDED] Verify that all Transfer-Encoding header fields are stripped from the message or that the request is blocked entirely. | 3 | |
| **13.7.3** | [ADDED] Verify that a full CRLF (\r\n) sequence is neutralized inside a HTTP/2 header. | 3 | 113 |
