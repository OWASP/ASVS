...
This section promotes generic web service security considerations, including basic web service hygiene practices and also schema validation of structured data.
...
* Due to issues with XXE attacks against DTDs, DTD validation should not be used, and framework DTD evaluation disabled as per the requirements set out in chapter V5.
...
| **13.2.2** | [DELETED, MERGED TO 13.1.9] | | |
...
| # | Description | Level | CWE |
| :---: | :--- | :---: | :---: |
| **13.3.1** | [DELETED, MERGED TO 13.1.9] | | |
