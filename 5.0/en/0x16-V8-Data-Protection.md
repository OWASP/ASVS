...
| **8.1.9** | [ADDED, SPLIT FROM 1.8.2] Verify that controls around sensitive data are implemented as defined in the documentation for the specific data's protection level and the documentation on the mechanisms needed to comply with relevant data protection and privacy regulations and standards. | | ✓ | ✓ | |
