...
| **15.3.4** | Verify that, if the application uses user IP addresses for functionality such as rate limiting or logging, it does this based on the user's actual IP address and that all proxying and middleware components correctly forward this to the application. | 2 | v5.0.be-10.4.6 |
