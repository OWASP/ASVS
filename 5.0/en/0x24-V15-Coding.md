...
| **15.4.3** | Verify that all access to shared resources is consistently checked and accessed in a single atomic operation to prevent TOCTOU race conditions, ensuring resource state consistency between check and use. | 3 | v5.0.be-10.7.3 |
