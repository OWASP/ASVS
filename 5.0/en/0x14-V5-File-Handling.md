...
| # | Description | Level | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **5.3.1** | Verify that files uploaded or generated by untrusted input which are stored in a public folder, are not executed as server-side program code when accessed directly with an HTTP request. | 1 | v5.0.be-12.4.1 |
