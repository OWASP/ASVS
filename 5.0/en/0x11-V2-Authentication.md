...
| **2.3.4** | [ADDED] System administrators should not be able to change any user's password, but only be able to initiate the password reset process for other users and nothing else regarding their password management. | ✓ | ✓ | ✓ | 620 |  |
