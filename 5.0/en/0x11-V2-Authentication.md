...
| **2.1.5** | Verify that users can change their password. | ✓ | ✓ | ✓ | 620 |
...
| **2.5.2** | Verify that password hints or knowledge-based authentication (so-called "secret questions") are not present. | ✓ | ✓ | ✓ | 640 |
