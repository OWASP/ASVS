...
| **2.3.4** | [ADDED] Verify that system administrators cannot change or choose any user's password, but rather can only initiate the password reset process for the user. | ✓ | ✓ | ✓ | 620 |
