...
| **2.2.4** | [MODIFIED, SPLIT TO 2.2.9] Verify that a hardware-based authentication mechanism that provides verifier impersonation resistance against phishing attacks (such as WebAuthn) is used. | | | ✓ | 308 | 4.3.1 |
