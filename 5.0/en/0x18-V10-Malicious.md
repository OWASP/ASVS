...
| **10.3.2** | Verify that the application only loads or executes code, modules, content or plugins from sources not under the application's direct control/protection if it employs integrity protections, such as code signing. | ✓ | ✓ | ✓ | 829 |
