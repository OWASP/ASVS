...
| **14.5.6** | [ADDED] Verify that the infrastructure follows RFC 2616 and ignores the `Content-Length` header field if also a `Transfer-Encoding` header field is present. | | ✓ | ✓ | 444 |
