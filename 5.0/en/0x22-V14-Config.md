...
| **14.1.8** | [ADDED] Ensure that build and deployment processes and their respective server instances are ephemeral - data and state should not persist after the process has been completed or otherwise exited. | | | ✓ | |
