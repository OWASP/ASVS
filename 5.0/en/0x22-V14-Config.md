...
| **14.3.5** | [ADDED, SPLIT FROM 4.3.2] Verify that application does not allow discovery or disclosure of file or directory metadata, such as Thumbs.db, .DS_Store, .git or .svn folders. | ✓ | ✓ | ✓ | |
