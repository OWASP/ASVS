...
| **5.2.6** | [MODIFIED] Verify that the application protects against SSRF attacks, by validating untrusted data against an allowlist of protocols, domains, paths and ports and sanitizing potentially dangerous characters before using the data to call another service. | ✓ | ✓ | ✓ | 918 |
