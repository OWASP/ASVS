...
| # | Description | L1 | L2 | L3 | CWE |
| :---: | :--- | :---: | :---: | :---: | :---: |
| **5.3.1** | [MODIFIED] Verify that output encoding is relevant for the interpreter and context required, such as encoding the relevant characters for HTML elements, HTML attributes, JavaScript, CSS, URL parameters, HTTP headers, or SMTP. | ✓ | ✓ | ✓ | 116 |
