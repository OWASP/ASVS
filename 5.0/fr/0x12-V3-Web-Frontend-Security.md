...
| **3.4.8** | Vérifiez que toutes les réponses HTTP qui lancent le rendu d'un document (comme les réponses de type texte/html) incluent le champ d'en-tête Cross-Origin-Opener-Policy avec la directive same-origin ou same-origin-allow-popups, selon les besoins. Cela empêche les attaques abusant de l'accès partagé aux objets Window, telles que le tabnabbing et le comptage d'images. | 3 | v5.0.be-50.3.8 |
