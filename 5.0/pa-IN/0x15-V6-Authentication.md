...
# V6 ਪ੍ਰਮਾਣੀਕਰਨ (Authentication)

## Control Objective

ਪ੍ਰਮਾਣੀਕਰਨ (Authentication) ਇੱਕ ਵਿਅਕਤੀ ਜਾਂ ਡਿਵਾਈਸ ਦੀ ਪ੍ਰਮਾਣਿਕਤਾ ਸਥਾਪਿਤ ਕਰਨ ਜਾਂ ਪੁਸ਼ਟੀ ਕਰਨ ਦੀ ਪ੍ਰਕਿਰਿਆ ਹੈ। ਇਸ ਵਿੱਚ ਇੱਕ ਵਿਅਕਤੀ ਦੁਆਰਾ ਜਾਂ ਇੱਕ ਡਿਵਾਈਸ ਬਾਰੇ ਕੀਤੇ ਗਏ ਦਾਅਵਿਆਂ ਦੀ ਪੁਸ਼ਟੀ ਕਰਨਾ, impersonation ਦੇ ਵਿਰੁੱਧ ਪ੍ਰਤੀਰੋਧ ਯਕੀਨੀ ਬਣਾਉਣਾ, ਅਤੇ passwords ਦੀ ਰਿਕਵਰੀ ਜਾਂ interception ਨੂੰ ਰੋਕਣਾ ਸ਼ਾਮਲ ਹੈ।
